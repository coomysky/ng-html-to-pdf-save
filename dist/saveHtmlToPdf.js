...
angular.module('htmlToPdfSave')
.directive('pdfSaveContent' ,  [ '$rootScope' , '$pdfStorage' , '$pdfSaveConfig', function ($rootScope , $pdfStorage, $pdfSaveConfig) {
        ...
        link : function(scope , element , attrs ) {
          ...
          //		continue ;
            ...
            if(matchTheIds(pdfId , broadcastedId)) {
              console.log('[Convert PDF Start]: ', pdfID );
              convertToPdf(elem , pdfId);
              console.log('[Conver PDF End]')
